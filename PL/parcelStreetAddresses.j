...
tie(%parcelInfo,"DB_File","./DB/ParcelInfoByAddress.db",O_RDWR,0666);
tie(%ParcelStreetAddresses,"DB_File","./DB/ParcelStreetAddresses.db",O_RDWR,0666);
...
tie(%StreetAddresses,"DB_File","./DB/MapStreetAddresses.db",O_RDWR|O_CREAT,0666);
tie(%StreetAddressLL,"DB_File","./DB/MapStreetAddressLL.db",O_RDWR|O_CREAT,0666);
open L,"$Lists/MapStreetAddressLL.txt";
while(<L>)
{ chop;
...
{ my $partialstreetname=@_[0];
  tie(%StreetAddresses,"DB_File","./DB/MapStreetAddresses.db",O_RDWR,0666);
